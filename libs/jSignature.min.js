...
(function(){$.fn.jSignature("addPlugin","instance","UndoButton",function(q){this.events.subscribe("jSignature.attachingEventHandlers",function(){if(this.settings[q]){var m=this.settings[q];"function"!==typeof m&&(m=function(){var e=$('<input type="button" value="上一步" style="box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);color: #FFFFFF;background-color: #4db6ac;border-radius:4px;position:absolute;display:none;margin:auto !important;top:auto" />').appendTo(this.$controlbarLower),k=e.width();e.css("right","50%");k!==e.width()&&e.width(k);return e});var k=m.call(this),
