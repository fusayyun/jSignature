...
(function(){$.fn.jSignature("addPlugin","instance","UndoButton",function(q){this.events.subscribe("jSignature.attachingEventHandlers",function(){if(this.settings[q]){var m=this.settings[q];"function"!==typeof m&&(m=function(){var e=$('<input type="button" value="上一步" class="btn waves-effect waves-light" style="border-radius:8px;position:absolute;display:none;margin:auto !important;top:auto" />').appendTo(this.$controlbarLower),k=e.width();e.css("left",0);k!==e.width()&&e.width(k);return e});var k=m.call(this),
